 ...
 * @author Aluno
 */
public class TelaLCardapio extends javax.swing.JFrame {

    /**
     * Creates new form telaLCliente
     */
    public TelaLCardapio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (tbTable.getColumnModel().getColumnCount() > 0) {
            ...
            tbTable.getColumnModel().getColumn(0).setPreferredWidth(70);
            ...
            tbTable.getColumnModel().getColumn(2).setPreferredWidth(350);
        }
    ...
    public void setTbTable(JTable tbTable) {
